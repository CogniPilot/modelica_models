...
partial block PartialController
  ...
  annotation(Documentation(info = "<html>
    ...
    mission plan (the trajectory-reference source), the flight
    ...
    collective thrust on the output side. All quantities are physical SI in the
    ...
    rotors), the three-mode taxonomy, and the collective-thrust semantics are
