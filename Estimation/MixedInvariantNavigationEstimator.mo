...
protected
  ...
  discrete Real mocapStale_s(start = 0.0, fixed = true);
  discrete Real gpsStale_s(start = 0.0, fixed = true);
  discrete Real opticalFlowStale_s(start = 0.0, fixed = true);
...
equation
  ...
  assert(covarianceInflateWindow_s > 0.0
    and covarianceInflateWindow_s < Estimation.MultiSensorInvariant.FiniteMagnitudeLimit,
    "covarianceInflateWindow_s must be finite and strictly positive");
  assert(covarianceInflateTimeConstant_s > 0.0
    and covarianceInflateTimeConstant_s < Estimation.MultiSensorInvariant.FiniteMagnitudeLimit,
    "covarianceInflateTimeConstant_s must be finite and strictly positive");
  assert(aidingStaleTimeout_s > 0.0
    and aidingStaleTimeout_s < Estimation.MultiSensorInvariant.FiniteMagnitudeLimit,
    "aidingStaleTimeout_s must be finite and strictly positive");
  assert(aidingDivergentWindow_s > covarianceInflateWindow_s
    and aidingDivergentWindow_s < Estimation.MultiSensorInvariant.FiniteMagnitudeLimit,
