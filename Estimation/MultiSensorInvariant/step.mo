...
function step
  ...
  input Real dt;
  input Estimation.MultiSensorInvariant.Tuning tuning;
  ...
  output Integer recoveryStage
    "Estimation.MultiSensorInvariant.Recovery* code for the automatic
     recovery ladder driven by sustained rejection";
  output Integer correctionOutcome
    "Estimation.MultiSensorInvariant.Correction* code for this tick's
     attempted aiding correction";
  output Integer correctionSource
    "Estimation.MultiSensorInvariant.Source* code the outcome refers to";
  ...
  output Integer anchorSourceNext
    "Estimation.MultiSensorInvariant.Source* code of the anchor in force";
...
algorithm
  ...
  if not initializedPrevious or reset then
    ...
    prior := Estimation.MultiSensorInvariant.State(
