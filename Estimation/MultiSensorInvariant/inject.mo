...
function inject "Right-inject a left-invariant tangent correction"
  input Estimation.MultiSensorInvariant.NominalState nominal;
  input Estimation.MultiSensorInvariant.TangentVector correction;
  output Estimation.MultiSensorInvariant.NominalState corrected;
protected
...
algorithm
  ...
  corrected := Estimation.MultiSensorInvariant.NominalState(
