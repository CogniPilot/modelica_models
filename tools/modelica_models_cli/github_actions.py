...
RDD2_REQUIRED_ARTIFACTS = (
    "rdd2-waypoint-summary.png",
    "rdd2-position-history.png",
    "rdd2-velocity-history.png",
    "rdd2-nees-nis-consistency.png",
    "rdd2-estimator-consistency.png",
    "rdd2-estimator-comparison.png",
    "waypoint-report.html",
    "waypoint-report.json",
    "waypoint-summary.md",
)
...
def verify(vehicle: str, figure: str, report: str) -> None:
    ...
    if vehicle == "rdd2":
        for artifact in RDD2_REQUIRED_ARTIFACTS:
            require_nonempty(directory / artifact)
