...
function fdSo3InverseJacobian
  "Central difference of SO(3) inverse, right-trivialized on both sides"
...
algorithm
  ...
  for j in 1:3 loop
    forward := LieGroups.SO3.Quat.log_map(LieGroups.SO3.Quat.product(
      q, LieGroups.SO3.Quat.inverse(LieGroups.SO3.Quat.product(
